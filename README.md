# Pedestrian_and_Vehicle_Recognition
...
Faster-R-CNN is the train algorithm we used. We are trainning our model using Caffe so there are no test code here. Training section mainly include parameter adjustment.
